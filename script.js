...
const translations = {
    en: {
        ...
        // Feature Categories
        'cat-general': 'General Features',
        'cat-general-1': 'Server statistics and information',
        'cat-general-2': 'Account verification system',
        'cat-general-3': 'Global hub network across servers',
        'cat-general-4': 'User profile and personal server data',
        'cat-general-5': 'Bot information and ownership details',
        'cat-general-6': 'Voting and Top.gg integration',

        'cat-moderation': 'Member Management & Moderation',
        'cat-moderation-1': 'Warning system with history tracking',
        'cat-moderation-2': 'Kick, ban, mute, and timeout controls',
        'cat-moderation-3': 'Role management for individual members',
        'cat-moderation-4': 'Mass role assignment and removal',
        'cat-moderation-5': 'Full moderation control tools',

        'cat-channel': 'Channel & Room Control',
        'cat-channel-1': 'Lock and unlock channels',
        'cat-channel-2': 'Clear messages and manage content',
        'cat-channel-3': 'Hide or show channels',
        'cat-channel-4': 'Enable or block links',
        'cat-channel-5': 'Restrict bot commands in specific rooms',
        'cat-channel-6': 'Channel and role removal tools',

        'cat-automation': 'Advanced Configuration & Automation',
        'cat-automation-1': 'Logging system (messages, deletions, invites)',
        'cat-automation-2': 'Welcome system setup',
        'cat-automation-3': 'Suggestions system',
        'cat-automation-4': 'Ticket system with points tracking',
        'cat-automation-5': 'Auto-reply and smart responses',
        'cat-automation-6': 'Custom aliases and command shortcuts',
        'cat-automation-7': 'Rating system enable/disable',
        'cat-automation-8': 'Invite tracking and reset',

        'cat-economy': 'Economy System',
        'cat-economy-1': 'Virtual bank and user profiles',
        'cat-economy-2': 'Currency transfers between members',
        'cat-economy-3': 'Coupons creation and usage',
        'cat-economy-4': 'Trust rewards system',
        'cat-economy-5': 'Background customization',
        'cat-economy-6': 'Leaderboards for users, servers, and tasks',

        'cat-entertainment': 'Entertainment & Interaction',
        'cat-entertainment-1': 'GX Wheel (luck-based game)',
        'cat-entertainment-2': 'Random opinions and judgments',
        'cat-entertainment-3': 'Avatar display tools',

        'cat-utilities': 'Additional Utilities',
        'cat-utilities-1': 'Islamic adhkar system',
        'cat-utilities-2': 'Embed message creation',
        'cat-utilities-3': 'Emoji automation in channels',
        'cat-utilities-4': 'Usage statistics tracking',
        'cat-utilities-5': 'Tax room configuration',
    ...
    ar: {
        ...
        // Feature Categories
        'cat-general': 'الميزات العامة',
        'cat-general-1': 'إحصائيات ومعلومات السيرفر',
        'cat-general-2': 'نظام التحقق من الحساب',
        'cat-general-3': 'شبكة المحور العالمية عبر السيرفرات',
        'cat-general-4': 'ملف المستخدم وبيانات السيرفر الشخصية',
        'cat-general-5': 'معلومات البوت وتفاصيل الملكية',
        'cat-general-6': 'التصويت والتكامل مع Top.gg',

        'cat-moderation': 'إدارة الأعضاء والإشراف',
        'cat-moderation-1': 'نظام التحذيرات مع تتبع السجل',
        'cat-moderation-2': 'عناصر التحكم في الطرد والحظر والكتم والمهلة',
        'cat-moderation-3': 'إدارة الأدوار للأعضاء الأفراد',
        'cat-moderation-4': 'تعيين وإزالة الأدوار الجماعية',
        'cat-moderation-5': 'أدوات التحكم الكاملة في الإشراف',

        'cat-channel': 'التحكم في القنوات والغرف',
        'cat-channel-1': 'قفل وفتح القنوات',
        'cat-channel-2': 'مسح الرسائل وإدارة المحتوى',
        'cat-channel-3': 'إخفاء أو إظهار القنوات',
        'cat-channel-4': 'تمكين أو حظر الروابط',
        'cat-channel-5': 'تقييد أوامر البوت في غرف محددة',
        'cat-channel-6': 'أدوات إزالة القنوات والأدوار',

        'cat-automation': 'الإعدادات المتقدمة والأتمتة',
        'cat-automation-1': 'نظام السجلات (الرسائل، الحذف، الدعوات)',
        'cat-automation-2': 'إعداد نظام الترحيب',
        'cat-automation-3': 'نظام الاقتراحات',
        'cat-automation-4': 'نظام التذاكر مع تتبع النقاط',
        'cat-automation-5': 'الرد التلقائي والردود الذكية',
        'cat-automation-6': 'الأسماء المستعارة المخصصة واختصارات الأوامر',
        'cat-automation-7': 'تمكين/تعطيل نظام التقييم',
        'cat-automation-8': 'تتبع الدعوات وإعادة التعيين',

        'cat-economy': 'نظام الاقتصاد',
        'cat-economy-1': 'البنك الافتراضي وملفات المستخدمين',
        'cat-economy-2': 'تحويلات العملة بين الأعضاء',
        'cat-economy-3': 'إنشاء واستخدام الكوبونات',
        'cat-economy-4': 'نظام مكافآت الثقة',
        'cat-economy-5': 'تخصيص الخلفية',
        'cat-economy-6': 'لوحات الصدارة للمستخدمين والسيرفرات والمهام',

        'cat-entertainment': 'الترفيه والتفاعل',
        'cat-entertainment-1': 'عجلة GX (لعبة الحظ)',
        'cat-entertainment-2': 'الآراء والأحكام العشوائية',
        'cat-entertainment-3': 'أدوات عرض الصورة الرمزية',

        'cat-utilities': 'الأدوات الإضافية',
        'cat-utilities-1': 'نظام الأذكار الإسلامية',
        'cat-utilities-2': 'إنشاء رسائل مدمجة',
        'cat-utilities-3': 'أتمتة الإيموجي في القنوات',
        'cat-utilities-4': 'تتبع إحصائيات الاستخدام',
        'cat-utilities-5': 'تكوين غرفة الضرائب',
